...
import type { LeadFormValues, LeadFormProps } from "@/shared/types/leads";
import { MESSAGE_MAX } from "@/pages/leads/validation/leadSchema";
import { useLeadFormValidation } from "@/pages/leads/validation/useLeadFormValidation";
